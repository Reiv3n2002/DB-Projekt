...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <h1>Willkommen, <?php echo htmlspecialchars($_SESSION['first_name'] . ' ' . $_SESSION['last_name']); ?>.</h1>
                        ...
                        <?php foreach ($recent_transactions as $transaction): ?>
                            <div class="transaction-item">
                                ...
                                <div class="transaction-details">
                                    ...
                                    <span class="transaction-amount <?php 
                                        ...
                                        foreach ($accounts as $acc) {
                                            if ($acc['account_id'] == $transaction['from_account_id']) {
                                                $isOutgoing = true;
                                                break;
                                            }
                                        }
                                ...
                                <div class="transaction-status">
                                    Status: <?php echo htmlspecialchars($transaction['status']); ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
