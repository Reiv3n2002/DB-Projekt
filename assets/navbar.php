...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-links">
            <a href="index.php" class="nav-link <?php echo $current_page ==
            'index.php'
                ? 'active'
                : ''; ?>">
                Ihre Spaßkasse
            </a>
            <a href="karriere.php" class="nav-link <?php echo $current_page ==
            'karriere.php'
                ? 'active'
                : ''; ?>">
                Karriere
            </a>
            <a href="service.php" class="nav-link <?php echo $current_page ==
            'service.php'
                ? 'active'
                : ''; ?>">
                Service-Center
        ...
        <div class="navbar-auth">
            ...
            <div class="user-dropdown">
                ...
                <div class="dropdown-content" id="adminDropdown">
                    <a href="admin/manage_jobs.php"><i class="fas fa-briefcase"></i> Jobs verwalten</a>
                    <a href="admin/manage_applications.php"><i class="fas fa-file-alt"></i> Bewerbungen</a>
                    <a href="admin/prices.php"><i class="fas fa-euro-sign"></i> Kontopreise</a>
                    <a href="admin/manage_users.php"><i class="fas fa-users-cog"></i> Benutzer verwalten</a>
                </div>
            </div>
            <?php endif; ?>
            <div class="user-dropdown">
