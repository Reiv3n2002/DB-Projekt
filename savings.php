    ...
    <div class="dashboard-container">
        <div class="sidebar">
            <nav class="dashboard-nav">
                ...
                <!-- <a href="new_savings_account.php"><i class="fas fa-plus-circle"></i> Konto eröffnen</a> -->
            </nav>
        </div>
            ...
            <section class="savings-overview">
                ...
                <div class="accounts-grid">
                    ...
                    <div class="no-accounts-message">
                        ...
                        <a href="new_savings_account.php" class="btn btn-primary">
                    ...
                    <div class="account-card">
                        <h3>Sparkonto</h3>
                        <p class="account-number">Kontonummer:
                        ...
                        <p class="interest-rate">
                            Zinssatz: <?php echo number_format(
                    ...
                    <div class="transaction-item">
                        ...
                        <div class="transaction-details">
                            ...
                            <span class="transaction-description">
                                Konto: <?php echo htmlspecialchars(
